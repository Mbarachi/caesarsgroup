...
export default function PayAsYouGoPromo() {
  ...
  const points = [
    ...
    "Pay just 50% of package fee up front",
  ...
  return (
    <section className="py-12 md:py-20">
      ...
      <div className="max-w-7xl mx-auto px-4 mb-8 text-center">
        ...
        <p className="text-gray-600 max-w-2xl mx-auto">Start with a 50% upfront payment and enjoy clean, reliable power while spreading the balance over 12 easy months.</p>
      </div>
