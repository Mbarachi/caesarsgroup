  ...
  const services = [
    {
      ...
      description: "Transform your home into a sustainable powerhouse with our residential solar solutions. Reduce your carbon footprint and enjoy significant savings on your energy bills. Simply tell us your power needs — we’ll conduct a thorough energy audit and handle the installation. Getting reliable alternative power has never been this easy.",
      icon: (
        <svg
          fill="currentColor"
          height="32"
      ...
      <div className="grid grid-cols-[repeat(auto-fit,minmax(280px,1fr))] gap-6">
        {services.map((service, index) => (
          <motion.div
            ...
            className="h-full"
          >
            <Card className="h-full border border-primary/20 bg-background-light dark:bg-background-dark hover:shadow-md transition-shadow">
